    ...
    public String onRequest(OfflinePlayer player, String check) {
        ...
        if (player == null) {
            ...
            if (check.contains("World_Popularity_")) {
                ...
                com.Util.Home home = HomeAPI.getHome(temp);
            ...
            if (check.equalsIgnoreCase("GetHomeName")) {
                ...
                com.Util.Home home = HomeAPI.getHome(p.getName());
                if (home != null) {
                ...
                if (check.equalsIgnoreCase("Name")) {
                    ...
                    if (Util.CheckIsHome(player.getPlayer().getWorld().getName().replace(Variable.world_prefix, ""))) {
                        ...
                        if (temp.contains("<PlayerName>")) {
                            temp = temp.replace("<PlayerName>", player.getPlayer().getWorld().getName().replace(Variable.world_prefix, ""));
                        }

                        if (temp.contains("<WorldName>")) {
                            temp = temp.replace("<WorldName>", player.getPlayer().getWorld().getName().replace(Variable.world_prefix, ""));
                        }
                ...
                if (check.equalsIgnoreCase("Tile")) {
                    ...
                    try {
                        Chunk[] i;
                        int arrayOfFile = (i = world.getLoadedChunks()).length;

                        for (int k = 0; k < arrayOfFile; k++) {
                            Chunk chunk = i[k];
                            BlockState[] home;
                            int homex = (home = chunk.getTileEntities()).length;

                            for (int temp = 0; temp < homex; temp++) {
                                BlockState bs = home[temp];
                                amount++;
                            }
                        }
                ...
                if (check.equalsIgnoreCase("World_Tile")) {
                    ...
                    try {
                        Chunk[] var194;
                        int var182 = (var194 = world.getLoadedChunks()).length;

                        for (int var170 = 0; var170 < var182; var170++) {
                            Chunk chunk = var194[var170];
                            BlockState[] var265;
                            int var252 = (var265 = chunk.getTileEntities()).length;

                            for (int var236 = 0; var236 < var252; var236++) {
                                BlockState bs = var265[var236];
                                amount++;
                            }
                        }
                    } catch (ExceptionInInitializerError e) {
                ...
                if (check.equalsIgnoreCase("Entity")) {
                    ...
                    int amount = 0;
                    Chunk[] var195;
                    int var183 = (var195 = world.getLoadedChunks()).length;

                    for (int var171 = 0; var171 < var183; var171++) {
                        Chunk chunk = var195[var171];
                ...
                if (check.equalsIgnoreCase("World_Entity")) {
                    ...
                    int amount = 0;
                    Chunk[] var253;
                    int var237 = (var253 = world.getLoadedChunks()).length;

                    for (int var217 = 0; var217 < var237; var217++) {
                        Chunk chunk = var253[var217];
                        amount += chunk.getEntities().length;
                    }
                ...
                if (check.equalsIgnoreCase("DropItem")) {
                    ...
                    int amount = 0;
                    Chunk[] var197;
                    int var184 = (var197 = world.getLoadedChunks()).length;

                    for (int var172 = 0; var172 < var184; var172++) {
                        Chunk chunk = var197[var172];
                        Entity[] var266;
                        int var254 = (var266 = chunk.getEntities()).length;

                        for (int var238 = 0; var238 < var254; var238++) {
                            Entity entity = var266[var238];
                ...
                if (check.equalsIgnoreCase("World_DropItem")) {
                    ...
                    int amount = 0;
                    Chunk[] var198;
                    int var185 = (var198 = world.getLoadedChunks()).length;

                    for (int var173 = 0; var173 < var185; var173++) {
                        Chunk chunk = var198[var173];
                        Entity[] var267;
                        int var255 = (var267 = chunk.getEntities()).length;

                        for (int var239 = 0; var239 < var255; var239++) {
                            Entity entity = var267[var239];
                            if (entity.getType() == EntityType.ITEM) {
                                amount++;
                            }
                        }
                ...
                if (check.equalsIgnoreCase("World_Flower")) {
                    ...
                    com.Util.Home home = HomeAPI.getHome(player.getPlayer().getName());
                    return String.valueOf(home.getFlowers());
                    ...
                    if (check.equalsIgnoreCase("World_Level")) {
                        ...
                        if (Variable.bungee) {
                            ...
                            File f = new File(
                                Variable.Tempf, String.valueOf(player.getPlayer().getWorld().getName().replace(Variable.world_prefix, "")) + ".yml"
                            );
                            YamlConfiguration yml = YamlConfiguration.loadConfiguration(f);
                            result_check = String.valueOf(yml.getInt("Level"));
                        }
                    ...
                    if (check.equalsIgnoreCase("World_pvp")) {
                        ...
                        if (Variable.bungee) {
                            if (MySQL.getPVP(player.getPlayer().getWorld().getName().replace(Variable.world_prefix, "")).equalsIgnoreCase("true")) {
                                result_check = Variable.Lang_YML.getString("PlaceHolders.Enable");
                            } else {
                                result_check = Variable.Lang_YML.getString("PlaceHolders.Disable");
                            }
                        ...
                        if (Variable.bungee) {
                            result_check = String.valueOf(
                                Main.JavaPlugin.getConfig().getInt("WorldBoard")
                                    + (Integer.valueOf(MySQL.getLevel(player.getPlayer().getName())) - 1) * Main.JavaPlugin.getConfig().getInt("UpdateRadius")
                            );
                        } else {
                            File f = new File(Variable.Tempf, String.valueOf(player.getPlayer().getName()) + ".yml");
                            YamlConfiguration yml = YamlConfiguration.loadConfiguration(f);
                    ...
                    if (check.equalsIgnoreCase("World_Radius")) {
                        ...
                        if (Variable.bungee) {
                            result_check = String.valueOf(
                                Main.JavaPlugin.getConfig().getInt("WorldBoard")
                                    + (Integer.valueOf(MySQL.getLevel(player.getPlayer().getWorld().getName().replace(Variable.world_prefix, ""))) - 1)
                    ...
                    if (check.equalsIgnoreCase("World_TeleportLocation")) {
                        ...
                        if (Variable.bungee) {
                            ...
                            result_check = String.valueOf(
                                "§aX: §d"
                                    + String.format("%.2f", yml.getDouble("X"))
                                    + "§a,Y: §d"
                                    + String.format("%.2f", yml.getDouble("Y"))
                                    + "§a,Z: §d"
                                    + String.format("%.2f", yml.getDouble("Z"))
                            );
                        }
                    }
                    ...
                    if (check.equalsIgnoreCase("UpdateMoney")) {
                        ...
                        if (Variable.bungee) {
                            if (Main.JavaPlugin.getConfig().getInt("MaxLevel") != Integer.valueOf(MySQL.getLevel(player.getPlayer().getName()))) {
                                result_check = String.valueOf(
                                    Main.JavaPlugin
                                        .getConfig()
                                        .getDoubleList("MoneyNeed")
                                        .get(Integer.valueOf(MySQL.getLevel(player.getPlayer().getName())) - 1)
                                );
                            } else {
                            ...
                            if (Main.JavaPlugin.getConfig().getInt("MaxLevel") != yml.getInt("Level")) {
                                result_check = String.valueOf(Main.JavaPlugin.getConfig().getDoubleList("MoneyNeed").get(yml.getInt("Level") - 1));
                            } else {
                                result_check = Variable.Lang_YML.getString("PlaceHolders.HasAlreadyReachLevelMax");
                            }
                        }
                    ...
                    if (check.equalsIgnoreCase("UpdatePoints")) {
                        ...
                        if (Variable.bungee) {
                            ...
                            YamlConfiguration yml = YamlConfiguration.loadConfiguration(f);
                            if (Main.JavaPlugin.getConfig().getInt("MaxLevel") != yml.getInt("Level")) {
                                result_check = String.valueOf(Main.JavaPlugin.getConfig().getDoubleList("PointsNeed").get(yml.getInt("Level") - 1));
                            } else {
                                result_check = Variable.Lang_YML.getString("PlaceHolders.HasAlreadyReachLevelMax");
                            }
                        }
                    ...
                    if (check.equalsIgnoreCase("UpdateItems")) {
                        ...
                        if (Variable.bungee) {
                            if (Main.JavaPlugin.getConfig().getInt("MaxLevel") != Integer.valueOf(MySQL.getLevel(player.getPlayer().getName()))) {
                                result_check = String.valueOf(
                                    ((String)Main.JavaPlugin
                                            .getConfig()
                                            .getStringList("ItemsNeed")
                                            .get(Integer.valueOf(MySQL.getLevel(player.getPlayer().getName())) - 1))
                                        .split(",")[0]
                                );
                            } else {
                            ...
                            if (Main.JavaPlugin.getConfig().getInt("MaxLevel") != yml.getInt("Level")) {
                                result_check = String.valueOf(
                                    ((String)Main.JavaPlugin.getConfig().getStringList("ItemsNeed").get(yml.getInt("Level") - 1)).split(",")[0]
                                );
                            } else {
                                result_check = Variable.Lang_YML.getString("PlaceHolders.HasAlreadyReachLevelMax");
                            }
                        ...
                        if (Variable.bungee) {
                            if (Main.JavaPlugin.getConfig().getInt("MaxLevel") != Integer.valueOf(MySQL.getLevel(player.getPlayer().getName()))) {
                                result_check = String.valueOf(
                                    ((String)Main.JavaPlugin
                                            .getConfig()
                                            .getStringList("ItemsChineseName")
                                            .get(Integer.valueOf(MySQL.getLevel(player.getPlayer().getName())) - 1))
                                        .split(",")[0]
                                );
                            } else {
                            ...
                            if (Main.JavaPlugin.getConfig().getInt("MaxLevel") != yml.getInt("Level")) {
                                result_check = String.valueOf(
                                    ((String)Main.JavaPlugin.getConfig().getStringList("ItemsChineseName").get(yml.getInt("Level") - 1)).split(",")[0]
                                );
                            } else {
                                result_check = Variable.Lang_YML.getString("PlaceHolders.HasAlreadyReachLevelMax");
                            }
                    ...
                    if (check.equalsIgnoreCase("UpdateItemsAmount")) {
                        ...
                        if (Variable.bungee) {
                            ...
                            if (Main.JavaPlugin.getConfig().getInt("MaxLevel") != yml.getInt("Level")) {
                                result_check = String.valueOf(
                                    ((String)Main.JavaPlugin.getConfig().getStringList("ItemsNeed").get(yml.getInt("Level") - 1)).split(",")[1]
                                );
                            } else {
                                result_check = Variable.Lang_YML.getString("PlaceHolders.HasAlreadyReachLevelMax");
                            }
                    ...
                    if (check.toUpperCase().contains("LEVELTOP_")) {
                        ...
                        if (Variable.bungee) {
                            ...
                            for (int b = 0; b < k; b++) {
                                ...
                                Home home = new Home(want_to, yml.getInt("Level"), yml.getInt("flowers"), yml.getInt("popularity"));
                                homelist.add(home);
                            }
