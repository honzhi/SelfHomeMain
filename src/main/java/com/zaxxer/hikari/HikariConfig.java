...
public class HikariConfig implements HikariConfigMXBean {
    ...
    public void setDriverClassName(String driverClassName) {
        ...
        if (driverClass == null) {
            throw new RuntimeException(
                "Failed to load driver class " + driverClassName + " in either of HikariConfig class loader or Thread context classloader"
            );
        }
    ...
    public void setExceptionOverrideClassName(String exceptionOverrideClassName) {
        ...
        if (overrideClass == null) {
            throw new RuntimeException(
                "Failed to load SQLExceptionOverride class "
                    + exceptionOverrideClassName
